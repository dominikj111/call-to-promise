...
describe('Utilities', () => {
	...
	describe('Api tests', () => {
		...
		it('should return true only when array of string is passed', () => {
			...
			expect(uti.isNotArrayOfStrings({'0':'3','1':'a',length:2})).to.eql(true)
		...
		it('should return true when array contains only string values', () => {
			...
			expect(uti.isArrayLikeOfStrings({'1':3,'2':'a',length:2})).to.eql(false)
			expect(uti.isArrayLikeOfStrings({'0':'3','1':'a'})).to.eql(false)

			expect(uti.isArrayLikeOfStrings({'0':'3','1':'a',length:2})).to.eql(true)
			...
			expect(uti.isNotArrayLikeOfStrings({'1':3,'2':'a',length:2})).to.eql(true)
			expect(uti.isNotArrayLikeOfStrings({'0':'3','1':'a'})).to.eql(true)

			expect(uti.isNotArrayLikeOfStrings({'0':'3','1':'a',length:2})).to.eql(false)
